...
public class DwarvenItemRegistry {
    ...
    public static final RegistryObject<Item> DWARVEN_STEEL_HELMET = ITEMS.register("dwarven_steel_helmet",
            () -> new ArmorItem(DwarvenArmorMaterialRegistry.DWARVEN, ArmorItem.Type.HELMET, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> DWARVEN_STEEL_CHESTPLATE = ITEMS.register("dwarven_steel_chestplate",
            () -> new ArmorItem(DwarvenArmorMaterialRegistry.DWARVEN, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> DWARVEN_STEEL_LEGGINGS = ITEMS.register("dwarven_steel_leggings",
            () -> new ArmorItem(DwarvenArmorMaterialRegistry.DWARVEN, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> DWARVEN_STEEL_BOOTS = ITEMS.register("dwarven_steel_boots",
            () -> new ArmorItem(DwarvenArmorMaterialRegistry.DWARVEN, ArmorItem.Type.BOOTS, new Item.Properties().fireResistant()));
